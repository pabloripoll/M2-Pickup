...
class AddRow extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId) {
            ...
            if (!$rowData->getEntityId()) {
                $this->messageManager->addError(__('Information no longer exist!'));
                $this->_redirect('pickup/info/rowdata');
                return;
            }
        }
        ...
        $title = $rowId ? __('Edit Info').$rowTitle : __('Add Info');
    ...
    {
        return $this->_authorization->isAllowed('Pripoll_PickupPoints::edit_pickup_info');
    }
}
